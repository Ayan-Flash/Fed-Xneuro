        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5 relative">
            ...
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center bg-white p-4 rounded-xl shadow-sm border border-gray-100 relative">
                ...
                <div className="mt-5 mb-2 text-[var(--color-secondary)]">
                  <step.icon size={32} />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="p-4 rounded-xl border border-gray-100 hover:border-[var(--color-primary)]/30 hover:shadow-md transition-all group bg-[var(--color-bg)]">
                <div className="w-10 h-10 rounded-lg bg-[var(--color-light-teal)] text-[var(--color-primary)] flex items-center justify-center mb-2.5 group-hover:bg-[var(--color-primary)] group-hover:text-white transition-colors">
                  <feature.icon size={20} />
                </div>
                <h3 className="text-base font-bold text-[var(--color-text-main)] mb-1">{feature.title}</h3>
