"""
TRAIN / Datasets / ADNI Multimodal Loader.
...
class ADNIClinicalParser:
    ...
    def parse_adni_merge(
        ...
        time_col = "Month" if "Month" in mci_df.columns else ("Months_bl" if "Months_bl" in mci_df.columns else "VISCODE")
...
class ADNIMultimodalDataset(Dataset):
    """
    PyTorch Dataset pairing ADNI longitudinal clinical records with 3D structural MRI scans.
    """
...
class ADNIDatasetManager:
    ...
    def __init__(
        self,
        data_dir: str = "TRAIN/data/raw/adni",
